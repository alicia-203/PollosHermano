...
namespace PollosHermano.Controllers
{
    public class RegionsController : Controller
    {
        ...
        public RegionsController(PollosHermanoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("RegionId,Nombre")] Region region)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RegionId,Nombre")] Region region)
        {
